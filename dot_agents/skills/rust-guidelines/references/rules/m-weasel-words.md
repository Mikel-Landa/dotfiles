...
Rust name is `Builder` (compare [M-INIT-BUILDER](m-init-builder.md)). A builder that can produce items repeatedly is still a builder.
...
around optional values (again, [M-INIT-BUILDER](m-init-builder.md)).
