...
![TEXT](https://microsoft.github.io/rust-guidelines/guidelines/docs/M-FIRST-DOC-SENTENCE_GOOD.png)

Otherwise, you might end up with _widows_ and a generally unpleasant reading flow:

![TEXT](https://microsoft.github.io/rust-guidelines/guidelines/docs/M-FIRST-DOC-SENTENCE_BAD.png)
