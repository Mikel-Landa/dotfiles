...
along with the guidelines from [Library / UX](https://microsoft.github.io/rust-guidelines/guidelines/libs/ux).
...
[M-MODULE-DOCS](m-module-docs.md)
[M-CANONICAL-DOCS](m-canonical-docs.md).
