...
![rules](https://img.shields.io/badge/rules-256-blue)
...
256 Rust rules your AI coding agent can use to write better code. Current for Rust 1.96 (2024 edition).
...
256 rules split into 26 categories:
