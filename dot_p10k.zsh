# Generated by Powerlevel10k configuration wizard on 2025-08-05 at 08:42 CEST.
...
() {
  ...
  # Pure-minimal segments + dynamic kubecontext. Other segment configs further
  # down in this file remain but are inert unless added back to these lists.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    dir                     # current directory
    vcs                     # git status
    command_execution_time  # previous command duration (>2s)
    newline
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    kubecontext             # shown only when typing kubectl/helm/k9s/etc
  )
